...
@Module({
  imports: [LlmModule],
  providers: [PipelineStateService, PipelineRunService, ClassifierProcessor, SummarizerProcessor, EmbedderProcessor, CorrelatorProcessor, BlocklistFilterProcessor, LlmEntityDetectorProcessor, StagingQueueService, PipelineService],
