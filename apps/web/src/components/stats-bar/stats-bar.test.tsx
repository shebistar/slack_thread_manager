...
const mockData: BriefingWithItems = {
  ...
  items: [
    ...
    { id: 'i-3', briefingId: 'b-1', threadId: 't-3', headline: 'h3', summaryText: 's3', workstreamName: 'Eng', sourceThreadUrl: null, itemType: 'orphaned_action', sortOrder: 2, latestActivityAt: null, messageCount: null, participantCount: null },
    { id: 'i-4', briefingId: 'b-1', threadId: 't-4', headline: 'h4', summaryText: 's4', workstreamName: null, sourceThreadUrl: null, itemType: 'gone_quiet', sortOrder: 3, latestActivityAt: null, messageCount: null, participantCount: null },
  ],
};
